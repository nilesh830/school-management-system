...
superadmin_schools_bp = Blueprint(
    'superadmin_schools', __name__, url_prefix='/api/v1/superadmin/schools'
)
...
def list_schools():
    ...
    result = SuperAdminService.get_all_schools(
...
def provision_school():
    ...
    return success_response(
        data=school_dict, message="School provisioned successfully", status=201
    )

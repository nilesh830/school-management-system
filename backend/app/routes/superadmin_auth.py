...
superadmin_auth_bp = Blueprint("superadmin_auth", __name__, url_prefix="/api/v1/superadmin/auth")
...
def sa_login():
    ...
    super_admin = SuperAdmin.query.filter_by(email=data["email"].lower().strip()).first()

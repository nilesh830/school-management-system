...
class TeacherSubject(db.Model):
    ...
    academic_year_id = db.Column(
        db.Integer, db.ForeignKey('academic_years.id'), nullable=True
    )
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            name='uq_teacher_subject_class_year'
        ),
    )
    ...
    def __repr__(self):
        return (
            f'<TeacherSubject teacher_id={self.teacher_id} '
            f'subject_id={self.subject_id} class_id={self.class_id}>'
        )

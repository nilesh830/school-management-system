...
class LeaveApplication(db.Model):
    ...
    leave_type = db.Column(db.Enum("sick", "family", "personal", "other", name="leave_types"), default="personal")
    status = db.Column(db.Enum("pending", "approved", "rejected", name="leave_status"), default="pending", index=True)

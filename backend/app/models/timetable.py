...
class Timetable(db.Model):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("section_id", "day_of_week", "period_no", name="uq_section_day_period"),
        # No teacher double-booking
        UniqueConstraint("teacher_id", "day_of_week", "period_no", name="uq_teacher_day_period"),
    )
    ...
    def __repr__(self):
        return f"<Timetable section_id={self.section_id} " f"day={self.day_of_week} period={self.period_no}>"

...
class ExamResult(db.Model):
    ...
    exam = db.relationship(
        'Exam', backref=db.backref('results', lazy='dynamic')
    )
    student = db.relationship(
        'Student', backref=db.backref('exam_results', lazy='dynamic')
    )
    subject = db.relationship(
        'Subject', backref=db.backref('exam_results', lazy='dynamic')
    )
    creator = db.relationship(
        'User', foreign_keys=[created_by],
        backref=db.backref('created_exam_results', lazy='dynamic')
    )
